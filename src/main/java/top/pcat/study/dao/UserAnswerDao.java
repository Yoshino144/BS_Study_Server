...
public interface UserAnswerDao {
    ...
    @Insert("INSERT INTO t_user_problem_data (user_id, subject_id, chapter_id, problem_id, answer, true_flag)\n" +
            "VALUES ()")
    int upProblemData(String user_id,int subject_id, int chapter_id,int problem_id,String answer,int true_flag);
